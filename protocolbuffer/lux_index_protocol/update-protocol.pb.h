...
enum Update_UpdateType {
  ...
  Update_UpdateType_ALTERATION = 2
};
...
const Update_UpdateType Update_UpdateType_UpdateType_MAX = Update_UpdateType_ALTERATION;
...
class Update : public ::google::protobuf::Message {
 public:
  ...
  static const UpdateType ALTERATION = Update_UpdateType_ALTERATION;
