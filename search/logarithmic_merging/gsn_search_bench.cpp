...
int main(int argc, char *argv[])
{
  ...
  std::cout << "token: " << tokens[1] << std::endl;
                      ...
                      uint8_t *bn, uint32_t sn, int len)
{
  ...
  while (1) {
    //std::cout << "gsnp: " << gsnp << ", gsnn: " << gsnn << std::endl;
    //std::cout << "dp: " << dp << ", dn: " << dn << std::endl;
    if (gsnp == gsnn) {
      ...
      if (dp == dn) {
<<<<<<< .mine
        std::cout << "doc match:" << dp << " - gsn: " << gsnp << std::endl;
=======
        //std::cout << "doc match - dp: " << dp << ", gsn: " << gsnp << std::endl;
>>>>>>> .r202
      ...
      if (prev_gsnp != gsnp && prev_gsnn == gsnn) {
        dn = next_gsn(bn, in, sn, prev_dn, gsnn); 
      } else if (prev_gsnn != gsnn && prev_gsnp == gsnp) {
    ...
    if (dp < 0 || dn < 0) {
      //std::cout << "breaking, dp: " << dp << ", dn: " << dn << std::endl;
      break;
    }
